...
extension BaseVideo {
    ...
    func buildVideoFromImageArray(imageArray: [UIImage], indexVideo: Int, completion: @escaping(AVAsset) -> ()) {
        //        for image in 0..<5 {
        ...
        selectedPhotosArray.append(contentsOf: imageArray)
        let path: String = NSHomeDirectory() + "/Documents/video" + "\(indexVideo).MP4"
        //imageArrayToVideoURL = NSURL(fileURLWithPath: NSHomeDirectory() + "/Documents/video1.MP4")
        imageArrayToVideoURL = NSURL(fileURLWithPath: path)
        ...
        if videoWriter.startWriting() {
            ...
            videoWriterInput.requestMediaDataWhenReady(on: media_queue, using: { () -> Void in
                ...
                videoWriter.finishWriting { () -> Void in
                    ...
                    let videoDataDict:[String: NSURL] = ["dataUser": self.imageArrayToVideoURL]
                    BaseCommons.registerTransmitNotificationcenter(BaseVideoNotificationKey.MAKE_VIDEO_FROM_IMAGE_ARRAY_COMPLITE, nil, videoDataDict)
    ...
    func buildVideoFromImageArrayWithAnimation() {
        ...
        let compositionVideoTrack:AVMutableCompositionTrack = composition.addMutableTrack(withMediaType: AVMediaType.video, preferredTrackID: CMPersistentTrackID())!
            ...
            for image in 0..<5 {
                imgarray.append(UIImage(named: "dog-\(image).jpg")!)
    ...
    //            blackLayer.add(fadeOutAnimation, forKey: "opacity")
        ...
        assetExport.outputFileType = AVFileType.mp4
            ...
            assetExport.exportAsynchronously(completionHandler: {
                ...
                default:
                    print("Exported")
                    currentVC.playVideoType1(linkURL: animatedVideoURL as URL)
                }
            })
        }
}
