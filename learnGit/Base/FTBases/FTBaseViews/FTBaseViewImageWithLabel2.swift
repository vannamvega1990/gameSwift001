//
//  FTBaseViewImageWithLabel2.swift
//  VegaFintech
//
//  Created by tran dinh thong on 8/20/21.
...
@IBDesignable
class FTBaseViewImageWithLabel2: FTBaseView {
    ...
    @IBInspectable var lableLeft: Bool = false
    
    @IBInspectable var setBgColor: UIColor = .white {
        didSet{
            rootView.backgroundColor = setBgColor
        }
    }
